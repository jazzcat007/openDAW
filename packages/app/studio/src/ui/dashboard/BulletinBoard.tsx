...
const notices: ReadonlyArray<Notice> = [
    {
        ...
        meta: "Jam rooms are ready whenever you are.",
        tone: "hot"
    },
    {
        tag: "COMMUNITY",
        ...
        meta: "The studio is better with a little noise in it.",
        tone: "fresh"
    },
    {
        tag: "WORKBENCH",
...
export const BulletinBoard = ({service}: Construct) => (
    <section className={className} aria-label="Community bulletin board">
        <header className="board-head">
            <div>
                <div className="eyebrow"><span className="live-dot"/>openDAW BBS · node 01</div>
